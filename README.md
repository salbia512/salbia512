# Hi there, I'm Salbia Kazmi 👋

### Full-Stack Developer | Next.js & AI Specialist
I bridge the gap between **pixel-perfect design** and **scalable intelligent code**. I specialize in building type-safe applications with **Next.js**, **TypeScript**, and **PostgreSQL**, while integrating cutting-edge **AI models** (Gemini, Grok) to solve real-world problems.
...
| :--- | :--- |
| **Frontend** | Next.js (App Router), React, TypeScript, Tailwind CSS, Bootstrap |
| **Backend** | Node.js, Express, REST APIs |
| **Database** | PostgreSQL, Prisma, Supabase |
| **AI & Automation** | Google Gemini API, xAI (Grok), Hugging Face |
| **Design & Workflow** | Figma (Design-to-Code), GitLab, GitHub, Vercel |
